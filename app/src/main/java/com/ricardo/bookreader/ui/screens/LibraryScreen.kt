            ...
            when {
                ...
                state.treeUri == null -> {
                    EmptyStateCard(
                        ...
                        description = "Elige tu biblioteca. BookReader navega por carpetas y abre TXT, Markdown y PDF sin pedir permisos de almacenamiento clásicos.",
                    ...
                    Column(modifier = Modifier.fillMaxSize()) {
                        Row(
                            ...
                            Text("${state.allBooks.size} libros", style = MaterialTheme.typography.labelLarge)
                        }
                            ...
                            items(state.folderEntries, key = { it.uri.toString() }) { entry ->
                                Row(
                                    ...
                                    Column(modifier = Modifier.weight(1f)) {
                                        ...
                                        Text(
                                            text = when {
                                                entry.isDirectory -> "Carpeta"
                                                entry.name.lowercase().endsWith(".pdf") -> "PDF"
                                                entry.name.lowercase().endsWith(".md") ||
                                                    entry.name.lowercase().endsWith(".markdown") -> "Markdown"
                                                else -> "Texto"
                                            },
